...
<div class="container">
  <div class="start-screen">
    ...
    {#if !gameStarted}
      <button id="start-button" on:click={startGame} aria-label="게임 시작 버튼">게임 시작</button>
    {/if}
  </div>
  <div class="game-wrapper">
    <div class="canvas-container">
      ...
      <div class="game-over-overlay">
        ...
        <button id="restart-button" on:click={startGame} aria-label="다시 시작 버튼">다시 시작</button>
      </div>
      {/if}
    </div>
  </div>
