<script lang="ts">
    ...
    console.log(data)
	const description = `${data.characterInfo.character_name}의 착용 장비, 헥사 스킬, 심볼에 대한 자세한 정보를 제공합니다.`;
    ...
    $: characterName = data.characterInfo.character_name;
  ...
  <svelte:head>
	...
	<meta property="og:image" content={data.characterInfo.character_image} />
	<meta property="og:type" content="website" />
	<meta name="twitter:title" content="{characterName} - 캐릭터 정보" />
	<meta name="twitter:description" content="{description}" />
	<meta name="twitter:image" content={data.characterInfo.character_image} />
